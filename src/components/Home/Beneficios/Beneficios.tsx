  ...
  return (
    <section className="w-full h-fit px-10 py-10">
      <div className="grid gap-8 lg:grid-cols-4 md:grid-cols-2">
        ...
        <Beneficio titulo="Sistema de Recompensa entre os Moradores" texto="Forneça premios a sua escolha para os moradores de acordo com os dados fornecidos por nós, pelo nosso sistema de ranking, assim gerando gameficação no seu condomínio. Dessa forma, você recompensa os moradores e fornece cada vez mais um meio ambiente sustentável para as próximas gerações">
