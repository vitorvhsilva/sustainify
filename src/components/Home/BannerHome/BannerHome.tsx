    ...
    <section className="w-full h-fit">
      <div className="relative w-full h-[80vh] bg-cover bg-no-repeat bg-[url('/home/bannerhome2.jpg')]">
        ...
        <div className="relative pt-10 justify-center items-center flex flex-col h-full">
          <h1 className="text-7xl text-corBranca text-center">Bem-vindo a <span className="text-cor1">Sustainify</span></h1>
          ...
          <button className="text-corBranca px-10 py-5 bg-cor1 rounded-full mx-auto block mt-20 text-xl hover:bg-cor2 hover:scale-110 transition duration-500">Fazer a diferença</button>
        </div>
      </div>
    </section>
  );
