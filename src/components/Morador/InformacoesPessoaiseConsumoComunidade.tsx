...
export default function InformacoesPessoaiseConsumoComunidade() {
  ...
  return (
    <div className="lg:w-[69%] w-[90%] h-fit pt-2">
      ...
      <h3 className="md:text-3xl text-xl my-2">Nome: <span className="text-cor1">Vitor Hugo da Silva</span></h3>
      <h3 className="md:text-3xl text-xl my-2">Email: <span className="text-cor1">vitor@email.com</span></h3>
      <h3 className="md:text-3xl text-xl my-2">CPF: <span className="text-cor1">52313213213</span></h3>
      <h3 className="md:text-3xl text-xl my-2">Telefone: <span className="text-cor1">11987321311</span></h3>
